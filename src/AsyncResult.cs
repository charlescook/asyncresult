...
// 
namespace CookComputing.AsynchronousProgrammingModel
{
  abstract internal partial class AsyncResult<TResult> : AsyncResultNoResult
  {
  ...
  abstract internal partial class AsyncResultNoResult : IAsyncResult
  {
